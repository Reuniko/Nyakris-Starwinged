...
float4 frag(v2f i, uint facing: SV_IsFrontFace): COLOR
{
	...
	clip(OutlineMask * (0.025 /*_LineWidth*/) - 0.001);
	...
	col.a *= float4(0.2140411,0.2140411,0.2140411,1).a;
	...
	col.rgb *= float4(0.2140411,0.2140411,0.2140411,1).rgb;
	if ((0.0 /*_OutlineMode*/) == 1)
	{
		col.rgb = lerp(col.rgb, mainTexture.rgb, (0.616 /*_OutlineTintMix*/));
	}
	finalColor = col;

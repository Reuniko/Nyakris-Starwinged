Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/0741f2cdf916c6f45a8a97deec3893ff"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.05574784,0.7077566,0.02147642,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.05574784,0.7077566,0.02147642,1).a;
